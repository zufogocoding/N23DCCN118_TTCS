      ...
      <div className="p-6 pt-0 flex-1 overflow-y-auto">
        ...
        <div className="mb-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {/* Card 1 */}
            <div onClick={() => handleProtectedAction(() => navigate('/playlist/chill-vibes'))} className="bg-[#181818] p-4 rounded-xl hover:bg-[#282828] transition-colors cursor-pointer group">
              <img
            ...
            {/* Card 2 */}
            <div onClick={() => handleProtectedAction(() => navigate('/playlist/workout-mix'))} className="bg-[#181818] p-4 rounded-xl hover:bg-[#282828] transition-colors cursor-pointer group">
              <img 
            ...
            {/* Card 3 */}
            <div onClick={() => handleProtectedAction(() => navigate('/playlist/liked-songs'))} className="bg-[#181818] p-4 rounded-xl hover:bg-[#282828] transition-colors cursor-pointer group">
        ...
        <div className="mb-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-5">
            {/* Song Card 1 */}
            <div onClick={() => handleProtectedAction(() => navigate('/song/1'))} className="bg-[#181818] p-4 rounded-xl hover:bg-[#282828] transition-colors cursor-pointer">
            ...
            {/* Song Card 2 */}
            <div onClick={() => handleProtectedAction(() => navigate('/song/2'))} className="bg-[#181818] p-4 rounded-xl hover:bg-[#282828] transition-colors cursor-pointer">
              ...
              <h3 className="font-bold text-white truncate text-base mb-1">Đi Giữa Trời Rực Rỡ</h3>
              <p className="text-sm text-[#a0a0a0] truncate">Ngô Lan Hương</p>
            </div>
            {/* Song Card 3 */}
            <div onClick={() => handleProtectedAction(() => navigate('/song/3'))} className="bg-[#181818] p-4 rounded-xl hover:bg-[#282828] transition-colors cursor-pointer">
